<tr>
  <td width='25%'><a href='<?php printf("$mphpself?ntt=3&view=yes&main_id=$record_id1")?>'>
  <img border='0' src='images/trackingvieweditbutton.jpg' width='76' height='15'></a></td>
  <td width='25%'><?php echo $myrow['c_code']?></td>
  <td width='25%'><?php echo $myrow['url_page_name']?></td>
...
*/
    ...
    if ($seclevel>3){
    ?>
      <a href='<?php printf("$mphpself?ntt=3&delete=yes&main_id=$record_id1")?>'>
